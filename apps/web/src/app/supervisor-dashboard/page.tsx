...
const StudentCard = ({ stu }: { stu: Student }) => (
  ...
  >
    ...
    <div className="flex w-48 flex-col gap-2">
      <button className="rounded-lg bg-[#374394] border border-[#1E1E1E] py-1 text-xs font-medium text-white hover:scale-105">
        Lihat Perkembangan
      </button>
      <button className="rounded-lg bg-[#BFC1FF] border border-[#1E1E1E] py-1 text-xs font-medium text-[#1E1E1E] hover:scale-105">
        Lihat Detail Tugas
      </button>
    </div>
  </div>
