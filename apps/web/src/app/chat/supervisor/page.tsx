...
const initialMsgs: Record<string, Msg[]> = {
    ...
    grace: [
        { from: "other", text: "Halo kak jane, apakah besok bisa meeting?", time: "15:37"},
        { from: "me", text: "Bisa banget dong!", time: "15:45", read: true},
        { from: "me", text: "Kamu maunya jam berapa?", time: "15:45", read: true},
    ],
};
