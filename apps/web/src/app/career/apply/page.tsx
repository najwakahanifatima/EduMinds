      ...
      <main className="mx-auto w-full max-w-3xl px-6 py-10">
        ...
        <div className="mt-14 flex flex-col gap-6 sm:flex-row sm:justify-between">
          <button
            ...
            className="rounded-md border border-[#1E1E1E] bg-[#EDCD50] px-6 py-2 text-sm font-bold hover:scale-105"
          >
          ...
          <button
            ...
            className="self-end rounded-md bg-[#B3EBCE] border border-[#1E1E1E] px-6 py-2 text-sm font-bold text-gray-900 hover:scale-105"
          >
            Lamar sekarang
          </button>
        </div>
